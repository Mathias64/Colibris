...
function(a, b) {
    ...
    a.widget("ui.ruler", {
        ...
        _setOption: function(a, b) {
            return "min" === a || "max" === a && b !== this.options[a] ? (this.options[a] = b, void this._regenerate()) : "scales" === a && b instanceof Array ? (this.options.scales = b, void this._regenerate()) : void 0
        },
        _createScales: function() {
            if (this.options.max !== this.options.min) for (var a = 0; a < this.options.scales.length; a++) this._createScale(this.options.scales[a], a)
        },
        ...
        _createTicks: function(a, b) {
            var c, d, e, f = b.first(this.options.min, this.options.max),
                ...
                h = !0;
            do c = f, f = b.next(c), d = (Math.min(f, this.options.max) - Math.max(c, this.options.min)) / g, e = this._createTick(c, f, b), a.append(e), e.css("width", 100 * d + "%"), h && c > this.options.min && e.css("margin-left", 100 * (c - this.options.min) / g + "%"), h = !1;
